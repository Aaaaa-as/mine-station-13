    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context,PINK_GARNET_ORE_PLACED_KEY,configuredFeatures.getOrThrow(ModConfiguredFeatures.PINK_GARNET_ORE_KEY),
                ModOrePlacement.modifiersWithCount(7,
                        HeightRangePlacementModifier.trapezoid(YOffset.fixed(-80),YOffset.fixed(23))));
...
//                        PlacedFeatures.createCountExtraModifier(0,.1f,4), ModBlocks.DRIFTWOOD_SAPLING));

    }

    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, MineStation13.id(name));
    }
