package com.artemy.minestation13.screen.custom;
...
public class PedestalScreenHandler extends ScreenHandler {
    ...
    public PedestalScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, BlockPos pos) {
